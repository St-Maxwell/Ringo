...
module machina_vla_real
    ...
    type, extends(machina_value) :: vla_real
        private
        integer :: sz = 0
    ...
    type :: vla_real_iterator
        private
        real(kind=f8), dimension(:), pointer :: ptr => null()
        integer :: cur = 1
...
contains
    ...
    pure function has_next(this) result(r)
        class(vla_real_iterator), intent(in) :: this
        logical :: r
    ...
    function get_next(this) result(ptr)
        class(vla_real_iterator), intent(inout), target :: this
        real(kind=f8), pointer :: ptr
    ...
    pure function has_next_const(this) result(r)
        class(vla_real_const_iterator), intent(in) :: this
        logical :: r
    ...
    function get_next_const(this) result(v)
        class(vla_real_const_iterator), intent(inout) :: this
        real(kind=f8) :: v
    ...
    subroutine resize(list, new_size)
        real(kind=f8), dimension(:), allocatable, intent(inout) :: list
    ...
    function cast_to_vla_real(ptr) result(v)
        class(machina_value), intent(in), target :: ptr
        type(vla_real), pointer :: v
    ...
    end function cast_to_vla_real

end module machina_vla_real
