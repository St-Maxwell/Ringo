...
program rhf_sto3g
    ...
    use diamat
    implicit none
    integer,parameter :: n_basis=2 
    integer,parameter :: n_atom=2
    ...
    coord(1,:)=(/0.00000000,0.00000000,1.50000000/)
    coord(2,:)=(/0.00000000,0.00000000,0.00000000/)
    ...
    call mix(C_coeff_a,C_coeff_b,S_overlap,2)
...
subroutine mix(Ca,Cb,S,n)
    implicit none
    integer :: n
    real(kind=8) :: Ca(n,n),Cb(n,n)
    real(kind=8),intent(in) :: S(n,n)
    real(kind=8) :: temp1(n),temp2(n),norm1,norm2,norm3,norm4
    ...
    norm1=(temp1(1)+temp2(1))**2+(temp1(2)+temp2(2))**2 &
             & +2.0D0*(temp1(1)+temp2(1))*(temp1(2)+temp2(2))*S(1,2)
    norm2=(temp2(1)-temp1(1))**2+(temp2(2)-temp1(2))**2 &
             & +2.0D0*(temp2(1)-temp1(1))*(temp2(2)-temp1(2))*S(1,2)
    norm3=(temp1(1)-temp2(1))**2+(temp1(2)-temp2(2))**2 &
             & +2.0D0*(temp1(1)-temp2(1))*(temp1(2)-temp2(2))*S(1,2)
    norm4=(-temp1(1)-temp2(1))**2+(-temp1(2)-temp2(2))**2 &
             & +2.0D0*(-temp1(1)-temp2(1))*(-temp1(2)-temp2(2))*S(1,2)
    
    Ca(:,1)=Ca(:,1)/dsqrt(norm1)
    Ca(:,2)=Ca(:,2)/dsqrt(norm2)
    Cb(:,1)=Cb(:,1)/dsqrt(norm3)
    Cb(:,2)=Cb(:,2)/dsqrt(norm4)
    return
end subroutine